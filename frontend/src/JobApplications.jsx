...
//     const token = localStorage.getItem('token');
//     const response = await fetch('http://localhost:8000/api/company/invite', {
//       method: 'POST',
//       headers: { 'token': token, 'Content-Type': 'application/json' },
//       body: JSON.stringify({
...
//             </div>
//             <form onSubmit={(e) => { e.preventDefault(); sendInvitation(); }}>
//               <div style={styles.formRow}>
//                 <label style={styles.label}>Interview Type</label>
//                 <select
//                   name="interviewType"
//                   value={inviteData.interviewType}
//                   onChange={(e) => setInviteData({ ...inviteData, interviewType: e.target.value })}
//                   style={styles.input}
//                 >
...
//                     onChange={(e) => setInviteData({ ...inviteData, location: e.target.value })}
//                     required
//                     style={styles.input}
//                   />
//                 </div>
...
//               {(inviteData.interviewType === 'Online' || inviteData.interviewType === 'Video') && (
//                 <div style={styles.formRow}>
...
//                     onChange={(e) => setInviteData({ ...inviteData, meetingLink: e.target.value })}
//                     required
//                     style={styles.input}
//                   />
//                 </div>
...
//                   onChange={(e) => setInviteData({ ...inviteData, interviewerEmail: e.target.value })}
//                   style={styles.input}
//                 />
//               </div>
...
//                   onChange={(e) => setInviteData({ ...inviteData, instructions: e.target.value })}
...
//                 <button type="submit" style={styles.submitBtn}>Send Invitation</button>
...
function JobApplications() {
  ...
  async function fetchApplications() {
    ...
    try {
      const response = await fetch(
        `http://localhost:8000/api/company/applications/${jobId}`,
        {
          headers: { token: token },
        }
      );
  ...
  //   const token = localStorage.getItem("token");
  //   const response = await fetch(
  //     `http://localhost:8000/api/company/application/${appId}`,
  //     {
  //       method: "PUT",
  //       headers: { token: token, "Content-Type": "application/json" },
  //       body: JSON.stringify({ status }),
