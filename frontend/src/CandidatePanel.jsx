...
function CandidatePanel() {
  ...
  const fetchCandidateProfile = async () => {
    ...
    const response = await fetch(getFetchUrl("api/candidate/getcandidate"), {
      headers: { 'token': token }
    });
  ...
  const checkProfileCompleteness = async () => {
    const token = localStorage.getItem('token');
    const response = await fetch(getFetchUrl("api/candidate/checkprofile"), {
      headers: { 'token': token }
    });
    const data = await response.json();
    if (data.success) {
  ...
  const fetchAllJobs = async () => {
    const token = localStorage.getItem('token');
    const response = await fetch(getFetchUrl("api/job/getalljob"), {
      headers: { 'token': token }
    });
    const data = await response.json();
    if (data.success) {
  ...
  const fetchMyApplications = async () => {
    const token = localStorage.getItem('token');
    const response = await fetch(getFetchUrl("api/application/applyhistory"), {
      headers: { 'token': token }
    });
    const data = await response.json();
    if (data.success) {
  ...
  const applyForJob = async () => {
    ...
    const token = localStorage.getItem('token');
    const response = await fetch(getFetchUrl("api/application/applyjob"), {
      method: 'POST',
